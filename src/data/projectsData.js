...
export const projectsData = [
    ...
    { 
        id: 3,
        projectName: 'Food Social App',
        projectDesc: 'Eatogram, a social media web app, offers foodies a platform to share dining experiences, connect, and communicate. Features include user profiles, news feed, messaging, and content sharing. Accessible on both web and mobile platforms for user convenience.',
